    ...
    Eigen::Vector3d &des_acc_debug)
{
  /* WRITE YOUR CODE HERE */
      ...
      des_acc = param_.gain.Ka * des.a + Kv.asDiagonal() * (des.v - odom.v) + Kp.asDiagonal() * (des.p - odom.p);
      ...
      if(roll > param_.max_angle) roll = param_.max_angle;
      else if(roll < -param_.max_angle) roll = -param_.max_angle;
      if(pitch > param_.max_angle) pitch = param_.max_angle;
      else if(pitch < -param_.max_angle) pitch = -param_.max_angle;
