...
if("TRUE" STREQUAL "TRUE")
  set(quadrotor_msgs_SOURCE_PREFIX /home/hhy/drone/src/FUEL/uav_simulator/Utils/quadrotor_msgs)
  set(quadrotor_msgs_DEVEL_PREFIX /home/hhy/drone/devel)
  ...
  set(quadrotor_msgs_INSTALL_PREFIX /home/hhy/drone/install)
...
if(NOT "/home/hhy/drone/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'quadrotor_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/hhy/drone/src/FUEL/uav_simulator/Utils/quadrotor_msgs/${idir}'.  ${_report}")
    endif()
